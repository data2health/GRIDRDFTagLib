...
public class FacilityEstablishedYearIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static FacilityEstablishedYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacilityEstablishedYearIterator.class);

...
public class FacilityWikipediaPageIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static FacilityWikipediaPageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(FacilityWikipediaPageIterator.class);

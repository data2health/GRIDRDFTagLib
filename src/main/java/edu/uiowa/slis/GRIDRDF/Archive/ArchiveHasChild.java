...
public class ArchiveHasChild extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static ArchiveHasChild currentInstance = null;
	private static final Log log = LogFactory.getLog(ArchiveHasChild.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theArchiveHasChildIterator.getHasChild());
		} catch (Exception e) {

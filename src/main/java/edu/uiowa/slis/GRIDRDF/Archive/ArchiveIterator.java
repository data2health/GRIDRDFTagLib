...
public class ArchiveIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static ArchiveIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArchiveIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.grid.ac/ontology/Archive> . "+

...
public class ArchiveEstablishedYearIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static ArchiveEstablishedYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(ArchiveEstablishedYearIterator.class);

...
public class HealthcareEstablishedYearIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static HealthcareEstablishedYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(HealthcareEstablishedYearIterator.class);

...
public class HealthcareIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static HealthcareIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(HealthcareIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.grid.ac/ontology/Healthcare> . "+

...
public class HealthcareIdIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static HealthcareIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(HealthcareIdIterator.class);

...
public class GovernmentIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static GovernmentIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.grid.ac/ontology/Government> . "+

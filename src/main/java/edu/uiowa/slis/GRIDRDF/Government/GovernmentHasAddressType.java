...
public class GovernmentHasAddressType extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static GovernmentHasAddressType currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentHasAddressType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theGovernmentHasAddressIterator.getType());
		} catch (Exception e) {

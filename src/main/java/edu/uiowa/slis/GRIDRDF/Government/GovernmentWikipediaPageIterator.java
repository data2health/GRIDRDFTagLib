...
public class GovernmentWikipediaPageIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static GovernmentWikipediaPageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentWikipediaPageIterator.class);

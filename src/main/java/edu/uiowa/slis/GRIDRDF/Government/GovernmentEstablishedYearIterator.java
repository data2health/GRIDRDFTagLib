...
public class GovernmentEstablishedYearIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static GovernmentEstablishedYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(GovernmentEstablishedYearIterator.class);

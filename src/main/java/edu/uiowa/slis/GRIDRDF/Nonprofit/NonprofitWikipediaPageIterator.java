...
public class NonprofitWikipediaPageIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static NonprofitWikipediaPageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonprofitWikipediaPageIterator.class);

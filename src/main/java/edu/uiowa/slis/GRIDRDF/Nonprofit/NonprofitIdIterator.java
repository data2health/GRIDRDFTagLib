...
public class NonprofitIdIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static NonprofitIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonprofitIdIterator.class);

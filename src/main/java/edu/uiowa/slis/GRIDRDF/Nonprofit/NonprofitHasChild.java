...
public class NonprofitHasChild extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static NonprofitHasChild currentInstance = null;
	private static final Log log = LogFactory.getLog(NonprofitHasChild.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theNonprofitHasChildIterator.getHasChild());
		} catch (Exception e) {

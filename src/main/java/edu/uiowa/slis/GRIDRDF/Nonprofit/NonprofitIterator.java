...
public class NonprofitIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static NonprofitIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(NonprofitIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.grid.ac/ontology/Nonprofit> . "+

...
public class EducationIdIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static EducationIdIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(EducationIdIterator.class);

...
public class CompanyWikipediaPageIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static CompanyWikipediaPageIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyWikipediaPageIterator.class);

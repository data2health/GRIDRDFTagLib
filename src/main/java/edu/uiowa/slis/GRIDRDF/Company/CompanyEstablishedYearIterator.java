...
public class CompanyEstablishedYearIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static CompanyEstablishedYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CompanyEstablishedYearIterator.class);

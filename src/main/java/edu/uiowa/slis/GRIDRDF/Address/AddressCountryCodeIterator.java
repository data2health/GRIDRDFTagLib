...
public class AddressCountryCodeIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static AddressCountryCodeIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(AddressCountryCodeIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://www.grid.ac/ontology/countryCode> ?s } ");
			if(rs.hasNext()) {

...
public class AddressHasAddressInverseIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s ?t where {"
					+" ?s <http://www.grid.ac/ontology/hasAddress> <" + subjectURI+ "> . "
	...
	public  void setHasAddressInverse(String theHasAddressInverse) {
		hasAddressInverse = theHasAddressInverse;
	}

...
public class OtherEstablishedYearIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static OtherEstablishedYearIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OtherEstablishedYearIterator.class);

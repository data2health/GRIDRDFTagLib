...
public class OtherIterator extends edu.uiowa.slis.GRIDRDF.TagLibSupport {
	static OtherIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(OtherIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			rs = getResultSet(prefix+
					" SELECT ?s ?lab where { "+
					"  ?s rdf:type <http://www.grid.ac/ontology/Other> . "+
